...
//struct CallTuple
//{
//    static void SetCallBack(RpcCallPtr call, std::coroutine_handle<> h, T& tuple)
//	{
//
//	}
//};
...
//{
//    static void SetCallBack(RpcCallPtr call, std::coroutine_handle<> h, std::tuple<Args...>& tup)
//	{
//		if (!call)
//		{
//			return;
...
//async_simple::coro::Lazy<T> CoRpcCall(RpcCallPtr call, std::string method, Args... args) noexcept
//{
...
//
//		if (!call)
//            co_return ResultType{};// rpc 返回值 必须包含默认构造函数
//		co_return co_await RpcCallAwaiter<ResultType>{[&](std::coroutine_handle<> h, ResultType& result) {
//			call->SetCallBack([&,h](ResultType r) { 
//				result = std::move(r); 
//				h.resume(); 
...
//{
//	template<typename... Args>
//    static async_simple::coro::Lazy<void> execute(RpcCallPtr call, std::string method, Args... args) noexcept
//    {
//        if (!call)
//            co_return;
//		co_return co_await RpcCallAwaiter<void>{[&](std::coroutine_handle<> h) {
...
//        (sizeof...(Rets) > 1),
//        CoRpcImpl<Rets...>,
//		SingleTypeSelector<std::conditional_t<(sizeof...(Rets) == 0), void, typename std::tuple_element<0, std::tuple<Rets...>>::type>>>;
//		//SingleTypeSelector<typename std::tuple_element<0, std::tuple<std::conditional_t<(sizeof...(Rets) == 0), void, Rets>...>>::type>>;
