...
class Meta final :
 ...
 public:
  ...
  void set_compress_type(::CompressType value);
  private:
  ::CompressType _internal_compress_type() const;
  void _internal_set_compress_type(::CompressType value);
  public:
...
inline ::CompressType Meta::_internal_compress_type() const {
  return static_cast< ::CompressType >(compress_type_);
}
inline ::CompressType Meta::compress_type() const {
  // @@protoc_insertion_point(field_get:Meta.compress_type)
  return _internal_compress_type();
}
inline void Meta::_internal_set_compress_type(::CompressType value) {
  
  compress_type_ = value;
}
inline void Meta::set_compress_type(::CompressType value) {
...
template <> struct is_proto_enum< ::CompressType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::CompressType>() {
  return ::CompressType_descriptor();
}
