...
const char descriptor_table_protodef_meta_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "pe\030\006 \001(\0162\r.CompressType*e\n\014CompressType\022"
  "\024\n\020CompressTypeNone\020\000\022\024\n\020CompressTypeGzi"
  "p\020\001\022\024\n\020CompressTypeZlib\020\002\022\023\n\017CompressTyp"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_meta_2eproto = {
  false, false, 301, descriptor_table_protodef_meta_2eproto, "meta.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          ::PROTOBUF_NAMESPACE_ID::uint64 val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_compress_type(static_cast<::CompressType>(val));
        } else
          goto handle_unusual;
        continue;
      default:
